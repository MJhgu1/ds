	...
	do {
		...
		case 's': DPRINT(cout << "case = " << option_char << endl;)
			...
			switch(algorithm_chosen){
				case 1 : comp = bubbleSort; break;
				case 2 : comp = insertionSort; break;
				case 3 : comp = quickSort; break;
				case 4 : comp = selectionSort; break;
			}
			comp(list,N);
			printList(list,N,max_print,per_line);
			end = clock();
		...
		case 'm': DPRINT(cout << "case = " << option_char << endl;)
			...
			cout << "Enter the max sample size to display: ";
			cin >> max_print;
			cout << endl;
			printList(list,N,max_print,per_line);
		...
		case 'd': DPRINT(cout << "case = " << option_char << endl;)
			...
			cout << "Enter the max sample per line to display: ";
			cin >> per_line;
			printList(list,N,max_print,per_line);
			break;
