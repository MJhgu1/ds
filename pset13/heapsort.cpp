...
//completion of this assignment. Signed: Minji Kim
...
int grow(char* a, char key, int N) {
...
#if 1
	char a[] = { ' ', 'S', 'O', 'R', 'T', 'E', 'X', 'A', 'M', 'P', 'L', 'E', '.', '\0', '\0' };
	//char a[] = { ' ', 't', 'h', 'e', 'q', 'u', 'i', 'c', 'k', 'b', 'r', 'o', 'w', 'n',
	//'f', 'o','x','j','u','m','p','s','o','v','e','r','t','h','e','l','a','z','y','d','o','g','.','\0', '\0' };
	//char a[] = {' ', '1','5','7','2','3','6','8','\0','\0'};
